...
export interface MultiSigAssetsManagementInterface extends utils.Interface {
  functions: {
    "buyFull(address,uint256)": FunctionFragment;
    "buyPart(address)": FunctionFragment;
    "clients(address)": FunctionFragment;
    "confirmTransaction(uint256)": FunctionFragment;
    "deletePart(address)": FunctionFragment;
    ...
    "updateClientsKYC(address[],address[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "buyFull",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "buyPart",
  ...
  encodeFunctionData(
    functionFragment: "updateClientsKYC",
    values: [PromiseOrValue<string>[], PromiseOrValue<string>[]]
  ): string;

  decodeFunctionResult(functionFragment: "buyFull", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "buyPart", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "clients", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "confirmTransaction",
    data: BytesLike
  ): Result;
  decodeFunctionResult(functionFragment: "deletePart", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "executeTransaction",
    data: BytesLike
  ): Result;
...
export interface MultiSigAssetsManagement extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiSigAssetsManagementInterface;
  ...
  functions: {
    ...
    updateClientsKYC(
      clientsToAdd: PromiseOrValue<string>[],
      clientsToRemove: PromiseOrValue<string>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
