...
contract Flower is ERC721, ERC721URIStorage, KeeperCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    ...
    uint256 interval;
    int public initprice;
    int public actualprice;
    int public result;

    constructor(uint _interval, address _priceaddress) ERC721("Flower Omnimask", "FOM") {
        interval = _interval;
        lastTimeStamp = block.timestamp;
        safeMint(msg.sender);
        priceEth = PriceConsumerV3(_priceaddress);
        initprice = priceEth.getLatestPrice();
    }
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        actualprice = priceEth.getLatestPrice();
        result = initprice - actualprice;
